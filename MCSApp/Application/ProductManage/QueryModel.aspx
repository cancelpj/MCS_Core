<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="QueryModel.aspx.cs" Inherits="MCSApp.Application.ProductManage.QueryModel" %>
               ...
               <ContentTemplate>
                <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" Width="100%"
                    ...
                    <Columns>
                        ...
                        <asp:TemplateField HeaderText="类型" Visible="true">
                            <ItemTemplate>
                                <asp:Label ID="lblorderID" runat="server" Text='<%# Bind("type") %>' Width="100px"></asp:Label>
                            </ItemTemplate>
                            <ItemStyle Wrap="False" />
                        </asp:TemplateField>
                    </Columns>
