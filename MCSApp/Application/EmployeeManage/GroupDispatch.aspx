<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="GroupDispatch.aspx.cs" Inherits="MCSApp.Application.EmployeeManage.GroupDispatch" %>
                                        ...
                                        <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False"
                                                ...
                                                <Columns>
                                                    <asp:TemplateField HeaderText="班组名称" >
                                                        <EditItemTemplate>
                                                            <asp:Label ID="txtName" runat="server" Text='<%# Bind("Name") %>' Width="100"></asp:Label>
                                                        </EditItemTemplate>
                                                        <ItemTemplate>
                                                    ...
                                                    <asp:TemplateField HeaderText="班组长工号">
                                                        <EditItemTemplate>
                                                            <asp:Label ID="txtLeaderID" runat="server" Text='<%# Bind("LeaderID") %>' Width="100px"></asp:Label>
                                                        </EditItemTemplate>
                                                        <ItemTemplate>
                                                    ...
                                                    <asp:TemplateField HeaderText="班组排工" >
                                                        <EditItemTemplate>
                                                            <asp:TextBox ID="txtWorkDispatch" runat="server" 
                                                                Text='<%# Bind("WorkDispatch") %>' Width="348px" MaxLength=2000 
                                                                TextMode=MultiLine Height="49px"></asp:TextBox>
                                                            <asp:RequiredFieldValidator ID="RequiredFieldValidatorw" runat="server" 
                                                                ControlToValidate="txtWorkDispatch" Display="None" ErrorMessage="班组排不能为空！" 
