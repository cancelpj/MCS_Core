<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="BugType.aspx.cs" Inherits="MCSApp.Application.SystemManage.BugType" %>
                                            ...
                                            <tr>
                                                <td >
                                                    <span style="font-size: 10pt">查询条件</span>：<asp:RadioButton ID="rdioBugID" runat="server"
                                                        Text="缺陷条码" GroupName="group1" Checked="True" Font-Size="10pt"></asp:RadioButton><asp:RadioButton
                                                            ID="rdioBug" runat="server" Text="缺陷" GroupName="group1" Font-Size="10pt">
                                                    </asp:RadioButton>&nbsp;
                                                ...
                                                <td  align=right>
                                                    <asp:Button ID="btnAdd" runat="server" BackColor="Transparent" BorderColor="Gray"
                                                        BorderWidth="1px" Font-Size="10pt" Height="20px" OnClick="lbtNew_Click" Text="添加缺陷类别"
                                    ...
                                    <ContentTemplate>
                                        ...
                                        <asp:Label ID="lblMsg" runat="server" ForeColor="Red" Text="表格正处在编辑状态，请先保存或取消!" Visible="False"
                                            Font-Size="10pt"></asp:Label><asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False"
                                                ...
                                                <Columns>
                                                    <asp:TemplateField HeaderText="缺陷条码" >
                                                        <EditItemTemplate>
                                                            <asp:TextBox ID="txtID" runat="server" Text='<%# Bind("ID") %>' Width="100"></asp:TextBox>
                                                            <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" 
                                                                ControlToValidate="txtID" Display="None" ErrorMessage="缺陷类别条码不能为空！" 
                                                    ...
                                                    <asp:TemplateField HeaderText="缺陷名称">
                                                        <EditItemTemplate>
                                                            <asp:TextBox ID="txtBug" runat="server" Text='<%# Bind("Bug") %>' Width="100px"
                                                                MaxLength="50"></asp:TextBox>
                                                            <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ControlToValidate="txtBug"
                                                                ErrorMessage="缺陷名称不能为空!" Display="None" SetFocusOnError="True"></asp:RequiredFieldValidator>
                                                        </EditItemTemplate>
                                                        <ItemTemplate>
                                                            <asp:Label ID="Label2" runat="server" Text='<%# Bind("Bug") %>' Width="100px"></asp:Label>
                                                        </ItemTemplate>
                                                        <ItemStyle Wrap="True" />
                                                    </asp:TemplateField>
